package com.azhar.exoplayerwithrecyclerviewapplication.view.utils
...
import com.azhar.exoplayerwithrecyclerviewapplication.view.adapter.PlayerViewHolder
...
class ExoPlayerRecyclerViewK : RecyclerView {
...
//    BandwidthMeter bandwidthMeter = new DefaultBandwidthMeter();
    ...
    private fun removeVideoView(videoView: StyledPlayerView?) {
        if(videoView?.parent !is ViewGroup) return
